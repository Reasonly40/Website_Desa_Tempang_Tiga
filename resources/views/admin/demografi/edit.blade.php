    ...
    <div class="bg-white p-6 md:p-8 rounded-lg shadow-md">
        <form method="POST" action="{{ route('admin.demografi.update') }}">
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-6">
                ...
                <div><label for="pek_pensiunan" class="block text-sm font-medium text-gray-700">Pensiunan</label><input id="pek_pensiunan" type="number" name="pek_pensiunan" value="{{ old('pek_pensiunan', $data->pek_pensiunan ?? 0) }}" required class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm"></div>                
